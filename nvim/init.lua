...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        ...
        sass = { 'oxfmt', stop_after_first = true },
        -- elixir = { 'mix' },
        -- heex = { 'mix' },
      },
    },
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'ruby', 'javascript', 'typescript', 'tsx', 'css', 'elixir', 'go', 'json', 'yaml', 'toml' },
      highlight = {
        enable = true,
...
vim.api.nvim_set_keymap('', '<Leader>wh', '<C-w>h', { silent = true, noremap = true })
vim.api.nvim_set_keymap('', '<Leader>wj', '<C-w>j', { silent = true, noremap = true })
