...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(helm-ag basic-theme base16-theme exec-path-from-shell color-theme-modern prettier-js rjsx-mode)
