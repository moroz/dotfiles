...
values."
  ...
  (setq-default
   ...
   dotspacemacs-themes (if (display-graphic-p) '(doom-vibrant spacemacs-dark moe-dark doom-laserwave moe-dark base16-gruvbox-dark-medium base16-material-palenight base16-solarized-dark base16-monokai) '(moe-dark spacemacs-dark))
