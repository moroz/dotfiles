...
values."
  (setq-default
   ...
   '(javascript
     html
     yaml
     elixir markdown ruby ivy emacs-lisp git
     (shell :variables
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-themes '(base16-onedark base16-gruvbox-dark-soft base16-summerfruit-dark base16-one-light)
