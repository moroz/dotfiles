...
values."
  (setq-default
   ...
   '(typescript
     ...
     syntax-checking auto-completion version-control
     )
   ;; List of additional packages that will be installed without being
   ;; wrapped in a layer. If you need some configuration for these
   ;; packages, then consider creating a layer. You can also put the
   ;; configuration in `dotspacemacs/user-config'.
   dotspacemacs-additional-packages '(helm-ag basic-theme base16-theme exec-path-from-shell color-theme-modern fcitx prettier-js rjsx-mode)
...
values."
  ...
  (setq-default
   ...
   dotspacemacs-themes (if (display-graphic-p) '(base16-gruvbox-dark-hard) '(spacemacs-dark))
